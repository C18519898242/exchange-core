...
public class ExchangeService {
    ...
    public static void main(String[] args) {
        ...
        log.info("Welcome to the {} Exchange Core Engine.", ExchangeManager.EXCHANGE_NAME);
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            switch (choice) {
                case "1":
                    ...
                    exchangeCore = ExchangeManager.coldStart();
                    break;
                case "2":
                    ...
                    try {
                        ...
                        exchangeCore = ExchangeManager.hotStart(snapshotId, baseSeq);
